...
try:
    _ = socket.gethostbyname(cas_swust_url)
...
class URL():
    auth_server = f"http://{cas_swust_url}/"
    auth_server_url = f"http://{cas_swust_url}/authserver/login?service="
    ...
    captcha_url = f'http://{cas_swust_url}/authserver/captcha'
    get_key_url = f'http://{cas_swust_url}/authserver/getKey'
